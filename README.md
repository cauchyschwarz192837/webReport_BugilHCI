# Full Web Report (HTML, CSS, JavaScript, Node.js and SQLite Backend, Containerised in Docker)
...
Our research goals, methods, results, references and datalog (Node.js backend) are made available here.
