...
Designed an embedded chatbot powered by the OpenAI API (LLM-based), generating natural-language explanations of stored research logs by dynamically querying the database and constructing structured context for model inference. Command-based interaction model (!!! prefix) to route user input for AI-assisted interpretation.
